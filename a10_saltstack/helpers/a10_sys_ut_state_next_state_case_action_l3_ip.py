...
AVAILABLE_PROPERTIES = ["ethernet","ipv4_address","ipv6_address","nat_pool","src_dst","trunk","uuid","ve","virtual_server","action_direction","case_number","name","state_name",]
...
def new_url(**kwargs):
    ...
    url_base = "/axapi/v3/sys-ut/state/{state_name}/next-state/{name}/case/{case_number}/action/{action_direction}/l3/ip/{src-dst}"
    f_dict = {}
    f_dict["src-dst"] = ""
