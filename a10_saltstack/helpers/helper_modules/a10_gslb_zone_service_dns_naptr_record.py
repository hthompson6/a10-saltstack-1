...
AVAILABLE_PROPERTIES = ["flag","naptr_target","order","preference","regexp","sampling_enable","service_proto","ttl","uuid","service_name","service_port","zone_name",]
...
CHILD_KEYS = ["naptr-target","service-proto","flag",]
