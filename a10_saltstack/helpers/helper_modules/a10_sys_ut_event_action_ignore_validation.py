...
AVAILABLE_PROPERTIES = ["all","l1","l2","l3","l4","uuid","action_direction","event_number",]
...
def new_url(**kwargs):
    ...
    url_base = "/axapi/v3/sys-ut/event/{event_number}/action/{action_direction}/ignore-validation"
    f_dict = {}
