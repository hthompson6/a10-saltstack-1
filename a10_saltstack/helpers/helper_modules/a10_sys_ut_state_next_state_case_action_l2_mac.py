...
AVAILABLE_PROPERTIES = ["address_type","ethernet","nat_pool","src_dst","trunk","uuid","value","ve","virtual_server","action_direction","case_number","name","state_name",]
...
def new_url(**kwargs):
    ...
    url_base = "/axapi/v3/sys-ut/state/{state_name}/next-state/{name}/case/{case_number}/action/{action_direction}/l2/mac/{src-dst}"
    f_dict = {}
    f_dict["src-dst"] = ""
