...
def new_url(module):
    ...
    url_base = "/axapi/v3/gslb/zone/{zone_name}/service/{service_service_port}+{{service_port}_service_name}/dns-ns-record/{ns-name}"
    f_dict = {}
    f_dict["ns-name"] = ""
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/gslb/zone/{zone_name}/service/{service_service_port}+{{service_port}_service_name}/dns-ns-record/{ns-name}"
    f_dict = {}
    f_dict["ns-name"] = module.params["ns-name"]
    f_dict["service_port_service_name"] = module.params["service_port_service_name"]
    f_dict["service_service_port"] = module.params["service_service_port"]
    f_dict["zone_name"] = module.params["zone_name"]
