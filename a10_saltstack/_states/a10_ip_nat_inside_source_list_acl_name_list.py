...
AVAILABLE_PROPERTIES = ["msl","name","pool","uuid",]
...
ret = dict(
    name="a10_ip_nat_inside_source_list_acl_name_list",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/ip/nat/inside/source/list/acl-name-list/{name}"
    f_dict = {}
    f_dict["name"] = ""
...
def create(**kwargs):
    payload = build_json("acl-name-list", kwargs)
    try:
