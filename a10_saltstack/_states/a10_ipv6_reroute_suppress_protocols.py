...
AVAILABLE_PROPERTIES = ["connected","ebgp","ibgp","isis","ospf","rip","static","uuid",]
...
ret = dict(
    name="a10_ipv6_reroute_suppress_protocols",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/ipv6/reroute/suppress-protocols"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("suppress-protocols", **kwargs)
    try:
