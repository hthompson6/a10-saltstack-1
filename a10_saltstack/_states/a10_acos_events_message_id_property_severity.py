...
AVAILABLE_PROPERTIES = ["severity_val","uuid",]
...
ret = dict(
    name="a10_acos_events_message_id_property_severity",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/acos-events/message-id/{log-msg}/property/severity"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("severity", kwargs)
    try:
