...
AVAILABLE_PROPERTIES = ["server_certificate_error","uuid",]
...
ret = dict(
    name="a10_snmp_server_enable_traps_ssl",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/snmp-server/enable/traps/ssl"
    f_dict = {}
