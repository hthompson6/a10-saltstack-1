...
AVAILABLE_PROPERTIES = ["period","remote_file","use_mgmt_port","uuid","wsdl",]
...
def new_url():
    ...
    url_base = "/axapi/v3/import-periodic/wsdl/{wsdl}"
    f_dict = {}
    f_dict["wsdl"] = ""
...
def create(**kwargs):
    payload = build_json("wsdl", **kwargs)
    try:
