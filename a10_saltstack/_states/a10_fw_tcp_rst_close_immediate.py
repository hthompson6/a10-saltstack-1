...
AVAILABLE_PROPERTIES = ["status","uuid",]
...
ret = dict(
    name="a10_fw_tcp_rst_close_immediate",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/fw/tcp-rst-close-immediate"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("tcp-rst-close-immediate", **kwargs)
    try:
