...
AVAILABLE_PROPERTIES = ["idle_timeout","limit","mode","uuid",]
...
def new_url():
    ...
    url_base = "/axapi/v3/fw/helper-sessions"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("helper-sessions", **kwargs)
    try:
