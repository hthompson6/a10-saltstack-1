...
def new_url():
    ...
    url_base = "/axapi/v3/slb/template/persist/destination-ip/{name}"
    f_dict = {}
    f_dict["name"] = ""
...
def create(**kwargs):
    ret = dict(
        name="a10_slb_template_persist_destination_ip",
        changes={},
        original_message="",
        result=False,
        comment=""
    ...
    try:
        post_result = __salt__['a10.create']("destination-ip",
                               new_url(),
...
def update(**kwargs):
    ...
    try:
        post_result = __salt__['a10.update']("destination-ip",
                               existing_url(**kwargs),     
                               AVAILABLE_PROPERTIES,
                               **kwargs)
        ret["changes"].update(**post_result)
...
def delete(**kwargs):
    ...
    try:
        post_result = __salt__['a10.delete']("destination-ip",
                               existing_url(**kwargs),      
                               **kwargs)
