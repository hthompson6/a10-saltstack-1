...
AVAILABLE_PROPERTIES = ["mode","uuid",]
...
ret = dict(
    name="a10_system_trunk_xaui_hw_hash",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/system/trunk-xaui-hw-hash"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("trunk-xaui-hw-hash", **kwargs)
    try:
