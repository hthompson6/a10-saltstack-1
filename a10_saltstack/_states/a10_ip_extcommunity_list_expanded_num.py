...
AVAILABLE_PROPERTIES = ["ext_list_num","rules_list","uuid",]
...
ret = dict(
    name="a10_ip_extcommunity_list_expanded_num",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/ip/extcommunity-list/expanded-num/{ext-list-num}"
    f_dict = {}
    f_dict["ext-list-num"] = ""
...
def create(**kwargs):
    payload = build_json("expanded-num", **kwargs)
    try:
