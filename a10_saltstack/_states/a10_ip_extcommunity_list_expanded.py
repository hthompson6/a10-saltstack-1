...
AVAILABLE_PROPERTIES = ["expanded","rules_list","uuid",]
...
ret = dict(
    name="a10_ip_extcommunity_list_expanded",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/ip/extcommunity-list/expanded/{expanded}"
    f_dict = {}
    f_dict["expanded"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/ip/extcommunity-list/expanded/{expanded}"
    f_dict = {}
    f_dict["expanded"] = kwargs["expanded"]
...
def create(**kwargs):
    payload = build_json("expanded", kwargs)
    try:
