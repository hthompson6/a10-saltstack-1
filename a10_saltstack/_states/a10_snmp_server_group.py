...
AVAILABLE_PROPERTIES = ["groupname","read","uuid","v3",]
...
def new_url():
    ...
    url_base = "/axapi/v3/snmp-server/group/{groupname}"
    f_dict = {}
    f_dict["groupname"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/snmp-server/group/{groupname}"
    f_dict = {}
    f_dict["groupname"] = kwargs["groupname"]
...
def create(**kwargs):
    payload = build_json("group", **kwargs)
    try:
