...
ret = dict(
    name="a10_sys_ut_event_action_ignore_validation",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/sys-ut/event/{event-number}/action/{direction}/ignore-validation"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("ignore-validation", **kwargs)
    try:
