...
AVAILABLE_PROPERTIES = ["device_id_list","uuid",]
...
ret = dict(
    name="a10_scaleout_cluster_cluster_devices",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/scaleout/cluster/{cluster-id}/cluster-devices"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("cluster-devices", **kwargs)
    try:
