...
AVAILABLE_PROPERTIES = ["sampling_enable","status","uuid",]
...
def new_url():
    ...
    url_base = "/axapi/v3/fw/tcp-window-check"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("tcp-window-check", kwargs)
    try:
