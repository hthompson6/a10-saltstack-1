...
ret = dict(
    name="a10_overlay_tunnel_vtep_destination_ip_address_vni",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/overlay-tunnel/vtep/{id}/destination-ip-address/{ip-address}/vni/{segment}"
    f_dict = {}
    f_dict["segment"] = ""
