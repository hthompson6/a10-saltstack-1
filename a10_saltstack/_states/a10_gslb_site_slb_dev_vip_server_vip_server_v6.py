...
ret = dict(
    name="a10_gslb_site_slb_dev_vip_server_vip_server_v6",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/gslb/site/{site-name}/slb-dev/{device-name}/vip-server/vip-server-v6/{ipv6}"
    f_dict = {}
    f_dict["ipv6"] = ""
...
def create(**kwargs):
    payload = build_json("vip-server-v6", kwargs)
    try:
