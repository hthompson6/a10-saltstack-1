...
AVAILABLE_PROPERTIES = ["period","use_mgmt_port","uuid",]
...
ret = dict(
    name="a10_import_periodic_file_inspection_bw_list",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/import-periodic/file-inspection-bw-list"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("file-inspection-bw-list", kwargs)
    try:
