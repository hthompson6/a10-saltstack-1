...
AVAILABLE_PROPERTIES = ["mgmt_index","uuid",]
...
ret = dict(
    name="a10_snmp_server_management_index",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/snmp-server/management-index"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("management-index", **kwargs)
    try:
