...
ret = dict(
    name="a10_aam_authentication_portal_notify_change_password",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/aam/authentication/portal/{name}/notify-change-password"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("notify-change-password", kwargs)
    try:
