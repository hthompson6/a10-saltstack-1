...
ret = dict(
    name="a10_visibility_reporting_reporting_db_elastic_search",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/visibility/reporting/reporting-db/elastic-search"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("elastic-search", kwargs)
    try:
