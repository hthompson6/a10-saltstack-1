...
def create(**kwargs):
    ret = dict(
        name="a10_slb_template_persist_cookie",
        changes={},
        original_message="",
        result=False,
        comment=""
    ...
    try:
        post_result = __salt__['a10.create']("cookie",
                               new_url(),
...
def update(**kwargs):
    ...
    try:
        post_result = __salt__['a10.update']("cookie",
                               existing_url(**kwargs),     
                               AVAILABLE_PROPERTIES,
                               **kwargs)
        ret["changes"].update(**post_result)
...
def delete(**kwargs):
    ...
    try:
        post_result = __salt__['a10.delete']("cookie",
                               existing_url(**kwargs),      
                               **kwargs)
