...
AVAILABLE_PROPERTIES = ["action","description","dst_file","file","file_handle","size",]
...
def new_url():
    ...
    url_base = "/axapi/v3/file/health-external"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("health-external", **kwargs)
    try:
