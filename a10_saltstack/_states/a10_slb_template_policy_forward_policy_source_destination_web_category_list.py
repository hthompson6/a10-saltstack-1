...
ret = dict(
    name="a10_slb_template_policy_forward_policy_source_destination_web_category_list",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/slb/template/policy/{name}/forward-policy/source/{name}/destination/web-category-list/{web-category-list}"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("web-category-list", **kwargs)
    try:
