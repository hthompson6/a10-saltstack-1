...
AVAILABLE_PROPERTIES = ["period","remote_file","ssl_crl","use_mgmt_port","uuid",]
...
ret = dict(
    name="a10_import_periodic_ssl_crl",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/import-periodic/ssl-crl/{ssl-crl}"
    f_dict = {}
    f_dict["ssl-crl"] = ""
...
def create(**kwargs):
    payload = build_json("ssl-crl", **kwargs)
    try:
