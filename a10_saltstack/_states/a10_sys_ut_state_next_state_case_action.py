...
AVAILABLE_PROPERTIES = ["delay","direction","drop","l1","l2","l3","tcp","template","udp","uuid",]
...
ret = dict(
    name="a10_sys_ut_state_next_state_case_action",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/sys-ut/state/{name}/next-state/{name}/case/{case-number}/action/{direction}"
    f_dict = {}
    f_dict["direction"] = ""
...
def create(**kwargs):
    payload = build_json("action", kwargs)
    try:
