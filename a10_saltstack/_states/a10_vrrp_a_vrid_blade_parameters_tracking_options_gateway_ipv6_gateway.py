...
ret = dict(
    name="a10_vrrp_a_vrid_blade_parameters_tracking_options_gateway_ipv6_gateway",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/vrrp-a/vrid/{vrid-val}/blade-parameters/tracking-options/gateway/ipv6-gateway/{ipv6-address}"
    f_dict = {}
    f_dict["ipv6-address"] = ""
...
def create(**kwargs):
    payload = build_json("ipv6-gateway", **kwargs)
    try:
