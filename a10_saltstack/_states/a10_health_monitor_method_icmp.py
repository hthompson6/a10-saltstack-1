...
AVAILABLE_PROPERTIES = ["icmp","ip","ipv6","transparent","uuid",]
...
ret = dict(
    name="a10_health_monitor_method_icmp",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/health/monitor/{name}/method/icmp"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("icmp", **kwargs)
    try:
