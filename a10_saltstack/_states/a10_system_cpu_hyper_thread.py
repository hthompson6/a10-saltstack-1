...
AVAILABLE_PROPERTIES = ["disable","enable",]
...
ret = dict(
    name="a10_system_cpu_hyper_thread",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/system/cpu-hyper-thread"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("cpu-hyper-thread", **kwargs)
    try:
