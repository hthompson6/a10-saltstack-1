...
AVAILABLE_PROPERTIES = ["database","database_name","db_column","db_column_integer","db_encrypted","db_name","db_password","db_password_str","db_receive","db_receive_integer","db_row","db_row_integer","db_send","db_username","uuid",]
...
ret = dict(
    name="a10_health_monitor_method_database",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/health/monitor/{name}/method/database"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("database", kwargs)
    try:
