...
ret = dict(
    name="a10_vrrp_a_vrid_blade_parameters_tracking_options",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/vrrp-a/vrid/{vrid-val}/blade-parameters/tracking-options"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("tracking-options", **kwargs)
    try:
