...
ret = dict(
    name="a10_scaleout_cluster_cluster_devices_device_id",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/scaleout/cluster/{cluster-id}/cluster-devices/device-id/{device-id}"
    f_dict = {}
    f_dict["device-id"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/scaleout/cluster/{cluster-id}/cluster-devices/device-id/{device-id}"
    f_dict = {}
    f_dict["device-id"] = kwargs["device-id"]
...
def create(**kwargs):
    payload = build_json("device-id", **kwargs)
    try:
