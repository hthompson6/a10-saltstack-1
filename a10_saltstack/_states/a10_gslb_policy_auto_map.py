...
AVAILABLE_PROPERTIES = ["all","module_disable","module_type","ttl","uuid",]
...
def new_url():
    ...
    url_base = "/axapi/v3/gslb/policy/{name}/auto-map"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("auto-map", kwargs)
    try:
