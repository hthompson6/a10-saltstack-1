...
AVAILABLE_PROPERTIES = ["dnssec_ds","period","remote_file","use_mgmt_port","uuid",]
...
ret = dict(
    name="a10_import_periodic_dnssec_ds",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/import-periodic/dnssec-ds/{dnssec-ds}"
    f_dict = {}
    f_dict["dnssec-ds"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/import-periodic/dnssec-ds/{dnssec-ds}"
    f_dict = {}
    f_dict["dnssec-ds"] = kwargs["dnssec-ds"]
...
def create(**kwargs):
    payload = build_json("dnssec-ds", **kwargs)
    try:
