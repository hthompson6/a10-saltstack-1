...
AVAILABLE_PROPERTIES = ["levelname","uuid",]
...
ret = dict(
    name="a10_logging_single_priority",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/logging/single-priority/{levelname}"
    f_dict = {}
    f_dict["levelname"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/logging/single-priority/{levelname}"
    f_dict = {}
    f_dict["levelname"] = kwargs["levelname"]
...
def create(**kwargs):
    payload = build_json("single-priority", kwargs)
    try:
