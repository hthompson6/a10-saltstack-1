...
AVAILABLE_PROPERTIES = ["bw_list","period","remote_file","use_mgmt_port","uuid",]
...
ret = dict(
    name="a10_import_periodic_bw_list",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/import-periodic/bw-list/{bw-list}"
    f_dict = {}
    f_dict["bw-list"] = ""
...
def create(**kwargs):
    payload = build_json("bw-list", kwargs)
    try:
