...
AVAILABLE_PROPERTIES = ["lid_list","name","uuid",]
...
ret = dict(
    name="a10_slb_template_dns_class_list",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/slb/template/dns/{name}/class-list"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("class-list", kwargs)
    try:
