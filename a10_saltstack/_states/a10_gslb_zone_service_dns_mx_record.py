...
ret = dict(
    name="a10_gslb_zone_service_dns_mx_record",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/gslb/zone/{name}/service/{service-port}+{service-name}/dns-mx-record/{mx-name}"
    f_dict = {}
    f_dict["mx-name"] = ""
...
def create(**kwargs):
    payload = build_json("dns-mx-record", kwargs)
    try:
