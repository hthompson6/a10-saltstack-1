...
AVAILABLE_PROPERTIES = ["auth_portal","period","remote_file","use_mgmt_port","uuid",]
...
ret = dict(
    name="a10_import_periodic_auth_portal",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/import-periodic/auth-portal/{auth-portal}"
    f_dict = {}
    f_dict["auth-portal"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/import-periodic/auth-portal/{auth-portal}"
    f_dict = {}
    f_dict["auth-portal"] = kwargs["auth-portal"]
...
def create(**kwargs):
    payload = build_json("auth-portal", **kwargs)
    try:
