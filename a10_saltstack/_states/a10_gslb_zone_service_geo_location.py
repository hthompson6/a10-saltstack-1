...
ret = dict(
    name="a10_gslb_zone_service_geo_location",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/gslb/zone/{name}/service/{service-port}+{service-name}/geo-location/{geo-name}"
    f_dict = {}
    f_dict["geo-name"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/gslb/zone/{name}/service/{service-port}+{service-name}/geo-location/{geo-name}"
    f_dict = {}
    f_dict["geo-name"] = kwargs["geo-name"]
...
def create(**kwargs):
    payload = build_json("geo-location", **kwargs)
    try:
