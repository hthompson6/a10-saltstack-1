...
AVAILABLE_PROPERTIES = ["nexthop_ipv6_ll","uuid","ve_num",]
...
ret = dict(
    name="a10_ipv6_route_static_bfd_ve",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/ipv6/route/static/bfd/ve/{ve-num}+{nexthop-ipv6-ll}"
    f_dict = {}
    f_dict["ve-num"] = ""
