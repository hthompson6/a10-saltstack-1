...
AVAILABLE_PROPERTIES = ["use_l3","use_l4","uuid",]
...
ret = dict(
    name="a10_system_trunk_load_balance",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/system/trunk/load-balance"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("load-balance", kwargs)
    try:
