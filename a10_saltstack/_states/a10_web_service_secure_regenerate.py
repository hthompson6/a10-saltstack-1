...
AVAILABLE_PROPERTIES = ["country","domain_name","state",]
...
ret = dict(
    name="a10_web_service_secure_regenerate",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/web-service/secure/regenerate"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("regenerate", **kwargs)
    try:
