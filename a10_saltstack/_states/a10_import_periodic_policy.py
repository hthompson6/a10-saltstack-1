...
AVAILABLE_PROPERTIES = ["period","policy","remote_file","use_mgmt_port","uuid",]
...
ret = dict(
    name="a10_import_periodic_policy",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/import-periodic/policy/{policy}"
    f_dict = {}
    f_dict["policy"] = ""
...
def create(**kwargs):
    payload = build_json("policy", **kwargs)
    try:
