...
AVAILABLE_PROPERTIES = ["ipv6_addr","secret","uuid",]
...
ret = dict(
    name="a10_radius_server_host_ipv6",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/radius-server/host/ipv6/{ipv6-addr}"
    f_dict = {}
    f_dict["ipv6-addr"] = ""
...
def create(**kwargs):
    payload = build_json("ipv6", **kwargs)
    try:
