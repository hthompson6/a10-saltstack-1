...
ret = dict(
    name="a10_gslb_zone_service_dns_ns_record",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/gslb/zone/{name}/service/{service-port}+{service-name}/dns-ns-record/{ns-name}"
    f_dict = {}
    f_dict["ns-name"] = ""
...
def create(**kwargs):
    payload = build_json("dns-ns-record", kwargs)
    try:
