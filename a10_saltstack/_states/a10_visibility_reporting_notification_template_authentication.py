...
ret = dict(
    name="a10_visibility_reporting_notification_template_authentication",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/visibility/reporting/notification-template/{name}/authentication"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("authentication", kwargs)
    try:
