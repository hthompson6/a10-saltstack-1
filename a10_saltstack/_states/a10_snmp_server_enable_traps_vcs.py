...
AVAILABLE_PROPERTIES = ["state_change","uuid",]
...
ret = dict(
    name="a10_snmp_server_enable_traps_vcs",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/snmp-server/enable/traps/vcs"
    f_dict = {}
