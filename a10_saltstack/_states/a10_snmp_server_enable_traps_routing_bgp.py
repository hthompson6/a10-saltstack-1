...
AVAILABLE_PROPERTIES = ["bgpBackwardTransNotification","bgpEstablishedNotification","uuid",]
...
ret = dict(
    name="a10_snmp_server_enable_traps_routing_bgp",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/snmp-server/enable/traps/routing/bgp"
    f_dict = {}
