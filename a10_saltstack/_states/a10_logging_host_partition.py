...
AVAILABLE_PROPERTIES = ["partition_name","shared","uuid",]
...
ret = dict(
    name="a10_logging_host_partition",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/logging/host/partition"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("partition", kwargs)
    try:
