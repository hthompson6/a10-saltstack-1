...
AVAILABLE_PROPERTIES = ["base","cn_value","dn_value","domain","domain_cfg","group","ipv4_addr","port_cfg","uuid",]
...
ret = dict(
    name="a10_ldap_server_host_ipv4",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/ldap-server/host/ipv4/{ipv4-addr}"
    f_dict = {}
    f_dict["ipv4-addr"] = ""
...
def create(**kwargs):
    payload = build_json("ipv4", kwargs)
    try:
