...
ret = dict(
    name="a10_router_bgp_address_family_ipv6_network_ipv6_network",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/router/bgp/{as-number}/address-family/ipv6/network/ipv6-network/{network-ipv6}"
    f_dict = {}
    f_dict["network-ipv6"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/router/bgp/{as-number}/address-family/ipv6/network/ipv6-network/{network-ipv6}"
    f_dict = {}
    f_dict["network-ipv6"] = kwargs["network-ipv6"]
...
def create(**kwargs):
    payload = build_json("ipv6-network", **kwargs)
    try:
