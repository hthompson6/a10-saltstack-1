...
AVAILABLE_PROPERTIES = ["rtp_stun_timeout","uuid",]
...
ret = dict(
    name="a10_cgnv6_stateful_firewall_alg_rtp",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/stateful-firewall/alg/rtp"
    f_dict = {}
