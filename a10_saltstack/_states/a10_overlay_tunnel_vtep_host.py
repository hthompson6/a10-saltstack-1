...
ret = dict(
    name="a10_overlay_tunnel_vtep_host",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/overlay-tunnel/vtep/{id}/host/{ip-addr}+{overlay-mac-addr}+{vni}+{destination-vtep}"
    f_dict = {}
    f_dict["ip-addr"] = ""
...
def create(**kwargs):
    payload = build_json("host", kwargs)
    try:
