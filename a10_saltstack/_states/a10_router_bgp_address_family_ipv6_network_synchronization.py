...
AVAILABLE_PROPERTIES = ["network_synchronization","uuid",]
...
ret = dict(
    name="a10_router_bgp_address_family_ipv6_network_synchronization",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/router/bgp/{as-number}/address-family/ipv6/network/synchronization"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("synchronization", kwargs)
    try:
