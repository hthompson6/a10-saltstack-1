...
AVAILABLE_PROPERTIES = ["acl_name","all_data_intf","eth_cfg","management","tunnel_cfg","user_tag","uuid","ve_cfg",]
...
ret = dict(
    name="a10_enable_management_service_https_acl_v6",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/enable-management/service/https/acl-v6/{acl-name}"
    f_dict = {}
    f_dict["acl-name"] = ""
...
def create(**kwargs):
    payload = build_json("acl-v6", kwargs)
    try:
