...
AVAILABLE_PROPERTIES = ["prefix_cfg","uuid",]
...
ret = dict(
    name="a10_router_ipv6_rip_distribute_list_prefix",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/router/ipv6/rip/distribute-list/prefix"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("prefix", kwargs)
    try:
