...
ret = dict(
    name="a10_scaleout_cluster_local_device_l2_redirect",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/scaleout/cluster/{cluster-id}/local-device/l2-redirect"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("l2-redirect", **kwargs)
    try:
