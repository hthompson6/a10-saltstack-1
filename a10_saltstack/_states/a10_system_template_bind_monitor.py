...
ret = dict(
    name="a10_system_template_bind_monitor",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/system/template-bind/monitor/{template-monitor}"
    f_dict = {}
    f_dict["template-monitor"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/system/template-bind/monitor/{template-monitor}"
    f_dict = {}
    f_dict["template-monitor"] = kwargs["template-monitor"]
...
def create(**kwargs):
    payload = build_json("monitor", kwargs)
    try:
