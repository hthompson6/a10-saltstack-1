...
AVAILABLE_PROPERTIES = ["add","administrator","callback","disable","newname","newpass","operator","password","privilege","setname","setpass","user",]
...
def new_url():
    ...
    url_base = "/axapi/v3/system/ipmi/user"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("user", **kwargs)
    try:
