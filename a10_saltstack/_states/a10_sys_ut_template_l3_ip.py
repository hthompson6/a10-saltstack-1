...
AVAILABLE_PROPERTIES = ["ethernet","ipv4_end_address","ipv4_start_address","ipv6_end_address","ipv6_start_address","nat_pool","src_dst","trunk","uuid","ve","virtual_server",]
...
ret = dict(
    name="a10_sys_ut_template_l3_ip",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/sys-ut/template/{name}/l3/ip/{src-dst}"
    f_dict = {}
    f_dict["src-dst"] = ""
