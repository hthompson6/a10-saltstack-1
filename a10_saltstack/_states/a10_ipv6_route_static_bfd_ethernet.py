...
ret = dict(
    name="a10_ipv6_route_static_bfd_ethernet",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/ipv6/route/static/bfd/ethernet/{eth-num}+{nexthop-ipv6-ll}"
    f_dict = {}
    f_dict["eth-num"] = ""
    f_dict["nexthop-ipv6-ll"] = ""
