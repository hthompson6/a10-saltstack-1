...
AVAILABLE_PROPERTIES = ["ip_cfg","ipv6_cfg","service_group","uuid",]
...
ret = dict(
    name="a10_netflow_monitor_destination",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/netflow/monitor/{name}/destination"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("destination", **kwargs)
    try:
