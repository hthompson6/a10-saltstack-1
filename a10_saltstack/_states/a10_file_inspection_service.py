...
AVAILABLE_PROPERTIES = ["enable","health_check_disable","service_down_action","uuid",]
...
ret = dict(
    name="a10_file_inspection_service",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/file-inspection/service"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("service", kwargs)
    try:
