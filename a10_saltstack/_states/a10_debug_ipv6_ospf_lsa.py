...
AVAILABLE_PROPERTIES = ["flooding","gererate","install","maxage","refresh","uuid",]
...
def new_url():
    ...
    url_base = "/axapi/v3/debug/ipv6/ospf/lsa"
    f_dict = {}
