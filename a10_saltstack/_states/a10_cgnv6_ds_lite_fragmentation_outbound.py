...
AVAILABLE_PROPERTIES = ["count","df_set","frag_action","uuid",]
...
ret = dict(
    name="a10_cgnv6_ds_lite_fragmentation_outbound",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/ds-lite/fragmentation/outbound"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("outbound", kwargs)
    try:
