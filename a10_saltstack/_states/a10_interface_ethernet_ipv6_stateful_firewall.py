...
ret = dict(
    name="a10_interface_ethernet_ipv6_stateful_firewall",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/interface/ethernet/{ifnum}/ipv6/stateful-firewall"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("stateful-firewall", kwargs)
    try:
