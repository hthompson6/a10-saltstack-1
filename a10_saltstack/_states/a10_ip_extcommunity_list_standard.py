...
AVAILABLE_PROPERTIES = ["rules_list","standard","uuid",]
...
ret = dict(
    name="a10_ip_extcommunity_list_standard",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/ip/extcommunity-list/standard/{standard}"
    f_dict = {}
    f_dict["standard"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/ip/extcommunity-list/standard/{standard}"
    f_dict = {}
    f_dict["standard"] = kwargs["standard"]
...
def create(**kwargs):
    payload = build_json("standard", **kwargs)
    try:
