...
AVAILABLE_PROPERTIES = ["action","certificate_name",]
...
ret = dict(
    name="a10_slb_ssl_expire_check_exception",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/slb/ssl-expire-check/exception"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("exception", kwargs)
    try:
