...
AVAILABLE_PROPERTIES = ["ethernet_cfg","uuid","vrid_list",]
...
ret = dict(
    name="a10_vrrp_a_restart_port_list",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/vrrp-a/restart-port-list"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("restart-port-list", kwargs)
    try:
