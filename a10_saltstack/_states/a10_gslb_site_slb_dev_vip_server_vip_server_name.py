...
ret = dict(
    name="a10_gslb_site_slb_dev_vip_server_vip_server_name",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/gslb/site/{site-name}/slb-dev/{device-name}/vip-server/vip-server-name/{vip-name}"
    f_dict = {}
    f_dict["vip-name"] = ""
...
def create(**kwargs):
    payload = build_json("vip-server-name", kwargs)
    try:
