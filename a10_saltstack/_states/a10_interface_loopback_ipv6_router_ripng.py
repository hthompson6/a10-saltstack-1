...
ret = dict(
    name="a10_interface_loopback_ipv6_router_ripng",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/interface/loopback/{ifnum}/ipv6/router/ripng"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("ripng", **kwargs)
    try:
