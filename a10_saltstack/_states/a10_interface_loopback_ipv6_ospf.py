...
AVAILABLE_PROPERTIES = ["bfd","cost_cfg","dead_interval_cfg","disable","hello_interval_cfg","mtu_ignore_cfg","priority_cfg","retransmit_interval_cfg","transmit_delay_cfg","uuid",]
...
ret = dict(
    name="a10_interface_loopback_ipv6_ospf",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/interface/loopback/{ifnum}/ipv6/ospf"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("ospf", kwargs)
    try:
