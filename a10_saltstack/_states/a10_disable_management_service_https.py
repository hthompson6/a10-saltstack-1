...
AVAILABLE_PROPERTIES = ["management","uuid",]
...
ret = dict(
    name="a10_disable_management_service_https",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/disable-management/service/https"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("https", **kwargs)
    try:
