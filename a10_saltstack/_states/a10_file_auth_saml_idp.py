...
AVAILABLE_PROPERTIES = ["action","dst_file","file","file_handle","size","verify_xml_signature",]
...
def new_url():
    ...
    url_base = "/axapi/v3/file/auth-saml-idp"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("auth-saml-idp", **kwargs)
    try:
