...
ret = dict(
    name="a10_gslb_zone_service_dns_a_record_dns_a_record_ipv6",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/gslb/zone/{name}/service/{service-port}+{service-name}/dns-a-record/dns-a-record-ipv6/{dns-a-record-ipv6}"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("dns-a-record-ipv6", **kwargs)
    try:
