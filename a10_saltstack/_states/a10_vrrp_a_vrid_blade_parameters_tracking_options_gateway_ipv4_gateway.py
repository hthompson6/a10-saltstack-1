...
AVAILABLE_PROPERTIES = ["ip_address","priority_cost","uuid",]
...
ret = dict(
    name="a10_vrrp_a_vrid_blade_parameters_tracking_options_gateway_ipv4_gateway",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/vrrp-a/vrid/{vrid-val}/blade-parameters/tracking-options/gateway/ipv4-gateway/{ip-address}"
    f_dict = {}
    f_dict["ip-address"] = ""
...
def create(**kwargs):
    payload = build_json("ipv4-gateway", kwargs)
    try:
