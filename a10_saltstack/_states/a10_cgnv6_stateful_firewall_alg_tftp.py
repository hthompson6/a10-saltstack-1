...
AVAILABLE_PROPERTIES = ["sampling_enable","tftp_value","uuid",]
...
ret = dict(
    name="a10_cgnv6_stateful_firewall_alg_tftp",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/stateful-firewall/alg/tftp"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("tftp", **kwargs)
    try:
