...
AVAILABLE_PROPERTIES = ["df_bit_value","uuid",]
...
ret = dict(
    name="a10_cgnv6_nat64_fragmentation_df_bit_transparency",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/nat64/fragmentation/df-bit-transparency"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("df-bit-transparency", **kwargs)
    try:
