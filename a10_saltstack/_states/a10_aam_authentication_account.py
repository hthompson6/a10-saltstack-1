...
AVAILABLE_PROPERTIES = ["kerberos_spn_list","sampling_enable","uuid",]
...
ret = dict(
    name="a10_aam_authentication_account",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/aam/authentication/account"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("account", **kwargs)
    try:
