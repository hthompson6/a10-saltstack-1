...
AVAILABLE_PROPERTIES = ["name","str_list","user_tag","uuid",]
...
ret = dict(
    name="a10_template_gtp_filter_list",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/template/gtp-filter-list/{name}"
    f_dict = {}
    f_dict["name"] = ""
...
def create(**kwargs):
    payload = build_json("gtp-filter-list", kwargs)
    try:
