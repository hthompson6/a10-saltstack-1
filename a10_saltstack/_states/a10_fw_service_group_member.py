...
AVAILABLE_PROPERTIES = ["name","port","sampling_enable","user_tag","uuid",]
...
ret = dict(
    name="a10_fw_service_group_member",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/fw/service-group/{name}/member/{name}+{port}"
    f_dict = {}
    f_dict["name"] = ""
    f_dict["port"] = ""
...
def create(**kwargs):
    payload = build_json("member", **kwargs)
    try:
