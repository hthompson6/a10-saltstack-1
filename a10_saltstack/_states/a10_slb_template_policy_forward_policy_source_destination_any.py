...
AVAILABLE_PROPERTIES = ["action","sampling_enable","uuid",]
...
ret = dict(
    name="a10_slb_template_policy_forward_policy_source_destination_any",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/slb/template/policy/{name}/forward-policy/source/{name}/destination/any"
    f_dict = {}
