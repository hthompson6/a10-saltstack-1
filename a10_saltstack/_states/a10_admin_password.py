...
AVAILABLE_PROPERTIES = ["encrypted_in_module","password_in_module","uuid",]
...
def new_url():
    ...
    url_base = "/axapi/v3/admin/{user}/password"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("password", **kwargs)
    try:
