...
AVAILABLE_PROPERTIES = ["all","linkdown","linkup","uuid",]
...
ret = dict(
    name="a10_snmp_server_enable_traps_snmp",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/snmp-server/enable/traps/snmp"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("snmp", kwargs)
    try:
