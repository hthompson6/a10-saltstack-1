...
ret = dict(
    name="a10_cgnv6_nat46_stateless_partition_prefix",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/nat46-stateless/partition-prefix/{partition}"
    f_dict = {}
    f_dict["partition"] = ""
...
def create(**kwargs):
    payload = build_json("partition-prefix", **kwargs)
    try:
