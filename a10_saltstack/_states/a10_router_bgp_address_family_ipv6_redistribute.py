...
AVAILABLE_PROPERTIES = ["connected_cfg","floating_ip_cfg","ip_nat_cfg","ip_nat_list_cfg","isis_cfg","lw4o6_cfg","nat_map_cfg","nat64_cfg","ospf_cfg","rip_cfg","static_cfg","uuid","vip",]
...
ret = dict(
    name="a10_router_bgp_address_family_ipv6_redistribute",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/router/bgp/{as-number}/address-family/ipv6/redistribute"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("redistribute", kwargs)
    try:
