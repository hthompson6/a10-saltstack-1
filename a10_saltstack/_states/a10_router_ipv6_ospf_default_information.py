...
ret = dict(
    name="a10_router_ipv6_ospf_default_information",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/router/ipv6/ospf/{process-id}/default-information"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("default-information", kwargs)
    try:
