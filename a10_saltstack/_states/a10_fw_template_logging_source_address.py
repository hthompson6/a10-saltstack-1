...
AVAILABLE_PROPERTIES = ["ip","ipv6","uuid",]
...
ret = dict(
    name="a10_fw_template_logging_source_address",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/fw/template/logging/{name}/source-address"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("source-address", **kwargs)
    try:
