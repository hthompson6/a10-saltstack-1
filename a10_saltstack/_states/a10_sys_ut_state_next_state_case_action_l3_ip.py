...
AVAILABLE_PROPERTIES = ["ethernet","ipv4_address","ipv6_address","nat_pool","src_dst","trunk","uuid","ve","virtual_server",]
...
ret = dict(
    name="a10_sys_ut_state_next_state_case_action_l3_ip",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/sys-ut/state/{name}/next-state/{name}/case/{case-number}/action/{direction}/l3/ip/{src-dst}"
    f_dict = {}
    f_dict["src-dst"] = ""
