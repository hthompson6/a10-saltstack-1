...
ret = dict(
    name="a10_sys_ut_state_next_state_case_action_tcp_options",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/sys-ut/state/{name}/next-state/{name}/case/{case-number}/action/{direction}/tcp/options"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("options", kwargs)
    try:
