...
AVAILABLE_PROPERTIES = ["ifindex","uuid",]
...
ret = dict(
    name="a10_netflow_monitor_sample_ethernet",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/netflow/monitor/{name}/sample/ethernet/{ifindex}"
    f_dict = {}
    f_dict["ifindex"] = ""
...
def create(**kwargs):
    payload = build_json("ethernet", **kwargs)
    try:
