...
AVAILABLE_PROPERTIES = ["part_name","uuid",]
...
ret = dict(
    name="a10_techreport_priority_partition",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/techreport/priority-partition/{part-name}"
    f_dict = {}
    f_dict["part-name"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/techreport/priority-partition/{part-name}"
    f_dict = {}
    f_dict["part-name"] = kwargs["part-name"]
...
def create(**kwargs):
    payload = build_json("priority-partition", kwargs)
    try:
