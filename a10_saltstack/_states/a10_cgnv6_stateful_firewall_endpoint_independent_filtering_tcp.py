...
ret = dict(
    name="a10_cgnv6_stateful_firewall_endpoint_independent_filtering_tcp",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/stateful-firewall/endpoint-independent-filtering/tcp"
    f_dict = {}
