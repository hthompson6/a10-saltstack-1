...
AVAILABLE_PROPERTIES = ["auth_type","domain","encrypted","http_port","https_port","password","proxy_host","secret_string","username","uuid",]
...
ret = dict(
    name="a10_web_category_proxy_server",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/web-category/proxy-server"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("proxy-server", **kwargs)
    try:
