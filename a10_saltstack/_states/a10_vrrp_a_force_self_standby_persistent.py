...
AVAILABLE_PROPERTIES = ["uuid","vrid",]
...
ret = dict(
    name="a10_vrrp_a_force_self_standby_persistent",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/vrrp-a/force-self-standby-persistent/{vrid}"
    f_dict = {}
    f_dict["vrid"] = ""
...
def create(**kwargs):
    payload = build_json("force-self-standby-persistent", **kwargs)
    try:
