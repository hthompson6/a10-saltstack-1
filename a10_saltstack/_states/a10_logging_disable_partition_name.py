...
AVAILABLE_PROPERTIES = ["disable_partition_name","uuid",]
...
ret = dict(
    name="a10_logging_disable_partition_name",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/logging/disable-partition-name"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("disable-partition-name", **kwargs)
    try:
