...
AVAILABLE_PROPERTIES = ["dest","mac","port","uuid","vlan",]
...
ret = dict(
    name="a10_network_mac_address_static",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/network/mac-address/static/{mac}+{vlan}"
    f_dict = {}
    f_dict["mac"] = ""
    f_dict["vlan"] = ""
...
def create(**kwargs):
    payload = build_json("static", kwargs)
    try:
