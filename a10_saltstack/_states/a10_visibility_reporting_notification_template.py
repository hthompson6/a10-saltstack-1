...
ret = dict(
    name="a10_visibility_reporting_notification_template",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/visibility/reporting/notification-template/{name}"
    f_dict = {}
    f_dict["name"] = ""
...
def create(**kwargs):
    payload = build_json("notification-template", kwargs)
    try:
