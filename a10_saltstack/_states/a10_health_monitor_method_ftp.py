...
AVAILABLE_PROPERTIES = ["ftp","ftp_encrypted","ftp_password","ftp_password_string","ftp_port","ftp_username","uuid",]
...
ret = dict(
    name="a10_health_monitor_method_ftp",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/health/monitor/{name}/method/ftp"
    f_dict = {}
