...
AVAILABLE_PROPERTIES = ["checksum","dest_port","dest_port_value","length","nat_pool","src_port_range","uuid",]
...
def new_url():
    ...
    url_base = "/axapi/v3/sys-ut/template/{name}/udp"
    f_dict = {}
