...
AVAILABLE_PROPERTIES = ["all_data_intf","eth_cfg","management","tunnel_cfg","uuid","ve_cfg",]
...
ret = dict(
    name="a10_disable_management_service_ping",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/disable-management/service/ping"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("ping", **kwargs)
    try:
