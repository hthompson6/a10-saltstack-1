...
AVAILABLE_PROPERTIES = ["allow_different_user","unique","uuid",]
...
ret = dict(
    name="a10_cgnv6_lsn_port_overloading_global",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/lsn/port-overloading/global"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("global", kwargs)
    try:
