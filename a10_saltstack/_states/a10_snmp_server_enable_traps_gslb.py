...
AVAILABLE_PROPERTIES = ["all","group","service_ip","site","uuid","zone",]
...
ret = dict(
    name="a10_snmp_server_enable_traps_gslb",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/snmp-server/enable/traps/gslb"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("gslb", kwargs)
    try:
