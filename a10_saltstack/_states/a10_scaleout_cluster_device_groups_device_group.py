...
AVAILABLE_PROPERTIES = ["device_group","device_id_list","user_tag","uuid",]
...
ret = dict(
    name="a10_scaleout_cluster_device_groups_device_group",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/scaleout/cluster/{cluster-id}/device-groups/device-group/{device-group}"
    f_dict = {}
    f_dict["device-group"] = ""
...
def existing_url(**kwargs):
    ...
    url_base = "/axapi/v3/scaleout/cluster/{cluster-id}/device-groups/device-group/{device-group}"
    f_dict = {}
    f_dict["device-group"] = kwargs["device-group"]
...
def create(**kwargs):
    payload = build_json("device-group", **kwargs)
    try:
