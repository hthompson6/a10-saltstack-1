...
AVAILABLE_PROPERTIES = ["overwrite","password","postfilename","remote_file","use_mgmt_port",]
...
ret = dict(
    name="a10_import_health_postfile",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/import/health-postfile"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("health-postfile", kwargs)
    try:
