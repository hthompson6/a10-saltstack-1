...
ret = dict(
    name="a10_cgnv6_stateful_firewall_stun_timeout",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/stateful-firewall/stun-timeout/{port}+{port-end}"
    f_dict = {}
    f_dict["port"] = ""
    f_dict["port-end"] = ""
...
def create(**kwargs):
    payload = build_json("stun-timeout", kwargs)
    try:
