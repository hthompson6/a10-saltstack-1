...
ret = dict(
    name="a10_cgnv6_stateful_firewall_tcp_idle_timeout",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/stateful-firewall/tcp/idle-timeout/{port}+{port-end}"
    f_dict = {}
    f_dict["port"] = ""
    f_dict["port-end"] = ""
...
def create(**kwargs):
    payload = build_json("idle-timeout", **kwargs)
    try:
