...
ret = dict(
    name="a10_router_bgp_neighbor_ipv4_neighbor",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/router/bgp/{as-number}/neighbor/ipv4-neighbor/{neighbor-ipv4}"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("ipv4-neighbor", **kwargs)
    try:
