...
AVAILABLE_PROPERTIES = ["cpu_usage","disable","packets_per_second","uuid",]
...
ret = dict(
    name="a10_system_cpu_load_sharing",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/system/cpu-load-sharing"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("cpu-load-sharing", **kwargs)
    try:
