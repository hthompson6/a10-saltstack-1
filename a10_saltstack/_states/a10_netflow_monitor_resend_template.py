...
AVAILABLE_PROPERTIES = ["records","timeout","uuid",]
...
ret = dict(
    name="a10_netflow_monitor_resend_template",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/netflow/monitor/{name}/resend-template"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("resend-template", **kwargs)
    try:
