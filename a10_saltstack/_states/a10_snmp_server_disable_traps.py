...
AVAILABLE_PROPERTIES = ["all","gslb","slb","slb_change","snmp","uuid","vrrp_a",]
...
ret = dict(
    name="a10_snmp_server_disable_traps",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/snmp-server/disable/traps"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("traps", kwargs)
    try:
