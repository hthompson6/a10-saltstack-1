...
ret = dict(
    name="a10_aam_authentication_relay_form_based_instance_request_uri",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/aam/authentication/relay/form-based/instance/{name}/request-uri/{match-type}+{uri}"
    f_dict = {}
    f_dict["match-type"] = ""
    f_dict["uri"] = ""
...
def create(**kwargs):
    payload = build_json("request-uri", **kwargs)
    try:
