...
AVAILABLE_PROPERTIES = ["rule_ipv6_prefix","uuid",]
...
def new_url():
    ...
    url_base = "/axapi/v3/cgnv6/map/translation/domain/{name}/default-mapping-rule"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("default-mapping-rule", kwargs)
    try:
