...
AVAILABLE_PROPERTIES = ["rtsp","rtsp_port","rtspurl","uuid",]
...
ret = dict(
    name="a10_health_monitor_method_rtsp",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/health/monitor/{name}/method/rtsp"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("rtsp", **kwargs)
    try:
