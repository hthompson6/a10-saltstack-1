...
AVAILABLE_PROPERTIES = ["vmaster_take_over",]
...
ret = dict(
    name="a10_vcs_vmaster_take_over",
    changed=False,
    original_message="",
    result={},
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/vcs/vmaster-take-over"
    f_dict = {}
...
def create(**kwargs):
    payload = build_json("vmaster-take-over", kwargs)
    try:
