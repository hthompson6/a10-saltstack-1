...
ret = dict(
    name="a10_router_bgp_address_family_ipv6_neighbor_ipv4_neighbor",
    changes={},
    original_message="",
    result=False,
    comment=""
...
def new_url():
    ...
    url_base = "/axapi/v3/router/bgp/{as-number}/address-family/ipv6/neighbor/ipv4-neighbor/{neighbor-ipv4}"
    f_dict = {}
